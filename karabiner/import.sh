...
$cli set parameter.keytokey_delayed_action_timeout 50
/bin/echo -n .
$cli set private.disable_parens 1
/bin/echo -n .
$cli set private.keyboard_numpad_keys_on_we 1
/bin/echo -n .
...
/bin/echo -n .
$cli set private.vi_directional_keys_on_wq 1
/bin/echo -n .
...
/bin/echo -n .
$cli set usercustom.control_l_to_hyper 1
/bin/echo -n .
$cli set usercustom.f18_to_l_control 1
/bin/echo -n .
