...
call s:HL('IncSearch',        s:ramp[0], s:accent,  'NONE')
...
call s:HL('ModeMsg',          s:accent,  'NONE',    'bold')
call s:HL('MoreMsg',          s:accent,  'NONE',    'NONE')
...
call s:HL('StatusLine',       s:ramp[2], 'NONE',    'NONE')
call s:HL('StatusLineNC',     s:ramp[2], 'NONE',    'italic')
call s:HL('StatusLineTerm',   s:ramp[0], s:accent,  'NONE')
call s:HL('StatusLineTermNC', s:ramp[0], s:accent,  'italic')
...
call s:HL('Title',            s:accent,  'NONE',    'bold')

" HTML
call s:HL('htmlBold',       'NONE',    'NONE', 'bold')
call s:HL('htmlBoldItalic', 'NONE',    'NONE', 'bold,italic')
call s:HL('htmlH1',         s:accent,  'NONE', 'bold,underline')
call s:HL('htmlH2',         s:accent,  'NONE', 'bold')
call s:HL('htmlH3',         s:accent,  'NONE', 'NONE')
call s:HL('htmlH4',         s:accent,  'NONE', 'italic')
call s:HL('htmlH5',         'NONE',    'NONE', 'NONE')
call s:HL('htmlH6',         'NONE',    'NONE', 'NONE')
call s:HL('htmlItalic',     'NONE',    'NONE', 'italic')
call s:HL('htmlLink',       'NONE',    'NONE', 'NONE')
call s:HL('htmlString',     'NONE',    'NONE', 'NONE')
call s:HL('htmlTag',        s:ramp[4], 'NONE', 'NONE')
call s:HL('htmlTagName',    s:ramp[4], 'NONE', 'NONE')

" Markdown (mostly defers to HTML)
call s:HL('markdownCode', s:accent, 'NONE', 'italic')
call s:HL('markdownURL',  s:accent, 'NONE', 'italic')
